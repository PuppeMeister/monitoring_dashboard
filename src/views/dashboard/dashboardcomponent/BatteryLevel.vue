        ...
        <div class="card">
            ...
            <!-- <div v-if="percentageReady" class="card-body p-0 pt-4 pb-4"> -->
             <div class="card-body p-0 pt-5 pb-5">       
                ...
                <div class=" ml-5 mr-5 pt-0 pb-0">
                      <!-- <div class="progress-bar bg-warning" role="progressbar" 
                      style="width: 25%" aria-valuenow="percentage" aria-valuemin="0" aria-valuemax="100">{{percentage}}%</div> -->
                      <!-- <bootstrap-progress-bar type="warning" :width="percentage" style="width: 100%  "></bootstrap-progress-bar> -->
                </div>
            ...
            <div class="card-footer bg-white br-0 pl-5 pr-5 pt-0 pb-0">
                    ...
                    <div class="col-md-6">
                        <div class="item text-center">
                            ...
                            <h4 class="m-0 pb-1">{{maxAmount}}<span> Watt</span></h4>
